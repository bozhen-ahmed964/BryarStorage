 <div class="right-sidebar" style="margin-top: 80px; margin-right: 10px;">
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  ><small style="margin-left: 5px; font-size: 14px"
                    >Image</small
                  >
                  <div class="progress">
                    <div
              ...
              <tr>
                <td>
                  <i class="far fa-file-video fs-4"></i
                  ><small style="margin-left: 5px; font-size: 14px"
                    >Video</small
                  >
                  <div class="progress">
      ...
      <div class="text-center">
        ...
        >
          <i class="far fa-edit" style="margin-right: 3px"></i>Edit</button
        ><button
          class="btn btn-dark btn-sm border rounded-pill"
          type="button"
          style="margin-left: 10px"
        >
          <i class="far fa-arrow-alt-circle-up" style="margin-right: 3px"></i
          >Upload
        </button>
      </div>
    </div>
